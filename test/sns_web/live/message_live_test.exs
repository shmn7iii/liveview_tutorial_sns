defmodule SnsWeb.MessageLiveTest do
  use SnsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Sns.MessagesFixtures

  @create_attrs %{contents: "some contents"}
  @update_attrs %{contents: "some updated contents"}
  @invalid_attrs %{contents: nil}
